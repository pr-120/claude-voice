...
Running Claude Code on three branches at once? A notification dings but you don't know if it's `myapp/main`, `myapp/feature/auth-login`, or `api-server/fix/signup-bug`. ClaudeVoice tells you — out loud.
